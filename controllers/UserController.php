...
class UserController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->password_reset_token = $model->newpass;
            if($model->validate()){
                $model->save();
                \Yii::$app->session->setFlash('alert','Password changed successfully.');
            }
            else
            {
                //print_r($model->getErrors());exit();
                \Yii::$app->session->setFlash('error','Old password not match!');         
            }   
